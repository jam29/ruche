...
exports.init = function(socket,sockets,callback) {
  connection.query("SELECT reponse,id_groupe,commentaire FROM reponses WHERE sequence ='011' AND phase='001'" ,function(err,rows,fields) {
  if (err) throw err;   
  console.log(rows);
  callback(null, { 
      groupe: {
        seq:"011",
        phas:"001",
        template: "allume2.ejs",
        data: "proposition_ruche11.json",
        cible:"container"
      },
       moderateur: {
