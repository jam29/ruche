...
exports.init = function(socket,sockets,callback) {
  connection.query("SELECT * FROM mail WHERE ruche=7 ORDER BY date",function(err,rows,fields) { 
...
exports.storeResponse = function(socket,sockets,data) {
 ...
 if ( data.question ) {
   ...
   connection.query("INSERT INTO  mail VALUES ('',"+data.idgrp+",NOW(),7,'ruche auvergne2bis : groupe "+data.idgrp+"',"+question+","+question+",0,0,0)", function (err) { if (err) throw err })
