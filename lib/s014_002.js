...
exports.storeResponse = function(socket,sockets,data) {
 ...
 if ( data.question ) {
   ...
   connection.query("INSERT INTO  mail VALUES ('',"+data.idgrp+",NOW(),14,'ruche auvergne1bis : groupe "+data.idgrp+"',"+question+","+question+",0,0,0)", function (err) { if (err) throw err })
 }
